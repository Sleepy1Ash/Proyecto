...
public class Cambios extends javax.swing.JFrame {
    ...
    void mostrartv(){
        ...
        try{
                ...
                pst.setString(1,no_venta1.getText());
                res=pst.executeQuery();
                if(res.next()){
                    txttotalpagar.setText(res.getString("monto_t"));
                }
                else{
    ...
    private void initComponents() {
        ...
        buscarpagos1 = new javax.swing.JButton();
        fecha_pag = new javax.swing.JTextField();
        fecha_lim = new javax.swing.JTextField();
        ...
        lbventa.setText("Folio del Cliente:");
        registroventas.add(lbventa);
        lbventa.setBounds(120, 110, 130, 20);
        ...
        registroventas.add(txtfolio1);
        txtfolio1.setBounds(310, 100, 140, 30);

        lbventa1.setFont(new java.awt.Font("Tw Cen MT", 0, 18)); // NOI18N
        lbventa1.setText("No_venta:");
        registroventas.add(lbventa1);
        lbventa1.setBounds(120, 160, 80, 20);
        ...
        pagos.add(jLabel3);
        jLabel3.setBounds(50, 350, 140, 20);
        ...
        buscarpagos1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buscarpagos1ActionPerformed(evt);
            }
        });
        ...
        fecha_pag.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                fecha_pagActionPerformed(evt);
            }
        });
        fecha_pag.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                fecha_pagKeyTyped(evt);
            }
        });
        pagos.add(fecha_pag);
        fecha_pag.setBounds(230, 350, 120, 30);

        fecha_lim.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                fecha_limActionPerformed(evt);
            }
        });
        fecha_lim.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                fecha_limKeyTyped(evt);
            }
        });
        pagos.add(fecha_lim);
        fecha_lim.setBounds(230, 310, 120, 30);
        ...
        eliminarpago.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                eliminarpagoKeyTyped(evt);
            }
        });
        ...
        eliminarpago.add(jLabel34);
        jLabel34.setBounds(100, 320, 100, 30);
        ...
        txtelpago.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtelpagoKeyTyped(evt);
            }
        });
        ...
        txtelpagado.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtelpagadoKeyTyped(evt);
            }
        });
        eliminarpago.add(txtelpagado);
        txtelpagado.setBounds(280, 220, 120, 30);

        txtelporpagar.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtelporpagarKeyTyped(evt);
            }
        });
        ...
        telefono3.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                telefono3KeyTyped(evt);
            }
        });
        cambiosclientes.add(telefono3);
        telefono3.setBounds(310, 420, 120, 30);

        folio3.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                folio3KeyTyped(evt);
            }
        });
        ...
        ap_pat3.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                ap_pat3KeyTyped(evt);
            }
        });
        ...
        municipio3.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                municipio3KeyTyped(evt);
            }
        });
        cambiosclientes.add(municipio3);
        municipio3.setBounds(310, 260, 120, 30);

        localidad3.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                localidad3KeyTyped(evt);
            }
        });
        cambiosclientes.add(localidad3);
        localidad3.setBounds(310, 300, 120, 30);

        calle3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                calle3ActionPerformed(evt);
            }
        });
        calle3.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                calle3KeyTyped(evt);
            }
        });
        ...
        casa3.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                casa3KeyTyped(evt);
            }
        });
        ...
        venta3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                venta3ActionPerformed(evt);
            }
        });
        venta3.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                venta3KeyTyped(evt);
            }
        });
        ...
        objetos3.addComponentListener(new java.awt.event.ComponentAdapter() {
            public void componentResized(java.awt.event.ComponentEvent evt) {
                objetos3ComponentResized(evt);
            }
        });
        ...
        objetos3.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                objetos3KeyTyped(evt);
            }
        });
        ...
        fecha_p3.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                fecha_p3KeyTyped(evt);
            }
        });
        cambiospagos.add(fecha_p3);
        fecha_p3.setBounds(310, 300, 110, 30);

        pago3.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                pago3KeyTyped(evt);
            }
        });
        ...
        total3.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                total3KeyTyped(evt);
            }
        });
        ...
        pagado3.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                pagado3KeyTyped(evt);
            }
        });
        ...
        pagar3.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                pagar3KeyTyped(evt);
            }
        });
        ...
        fecha_lim3.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                fecha_lim3KeyTyped(evt);
            }
        });
        ...
        busquedasclientes.setBounds(0, 0, 710, 510);
    ...
    private void btnsalir3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsalir3ActionPerformed
        ...
        no_venta1.setText(null);
        fecha_pag.setText(null);
    ...
    private void btnguardar2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardar2ActionPerformed
                ...
                String b=String.valueOf(mes);
                String c=String.valueOf(dia);
                String fecha1=a+b+c;
                String fecha2;
                float resta;
                txtpagado.setEnabled(false);
                ...
                fecha1=(fecha_pag.getText());
                fecha2=(fecha_lim.getText());
                resta=total_pag-pagado;
                txtporpagar.setText(""+resta);
                conexion cc= new conexion();
                Connection cn=cc.conexion();
                String sql="";              
            ...
            try {
                ...
                Logger.getLogger(Cambios.class.getName()).log(Level.SEVERE, null, ex);
                JOptionPane.showMessageDialog(null,"El número de venta no existe");
            }
    ...
    private void eliminarclienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_eliminarclienteMouseClicked
         int resp=JOptionPane.showConfirmDialog(null,"¿Seguro que quieres eliminar?");
        eliminarcliente.setEnabled(false);
        cancelar3.setEnabled(true);
        conexion cc= new conexion();
        Connection cn=cc.conexion();
        ...
        try{
            ...
            //Logger.getLogger(Cambios.class.getName()).log(Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(null,"Error al eliminar\nEl cliente esta asignado en otras tablas.");
        }   
    ...
    private void eliminarventasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarventasActionPerformed
        ...
        try{
            ...
            //Logger.getLogger(Cambios.class.getName()).log(Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(null,"Error al eliminar\nLa venta esta asignada en otras tablas");
        }     
    ...
    private void buscarpagos1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarpagos1ActionPerformed
        mostrartv();
        ...
        int mes = fecha.get(Calendar.MONTH);
        int dia = fecha.get(Calendar.DAY_OF_MONTH);
        fecha_pag.setText(""+año+"/"+(mes+1)+"/"+dia);
        ////////////////////////////////
        int año2 = fecha.get(Calendar.YEAR);
        int mes2 = fecha.get(Calendar.MONTH);
        int dia2 = fecha.get(Calendar.DAY_OF_MONTH);
        fecha_lim.setText(""+año+"/"+(mes+1)+"/"+dia);
    }//GEN-LAST:event_buscarpagos1ActionPerformed

    private void fecha_pagActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fecha_pagActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_fecha_pagActionPerformed

    private void fecha_pagKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_fecha_pagKeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_fecha_pagKeyTyped

    private void fecha_limActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fecha_limActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_fecha_limActionPerformed

    private void fecha_limKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_fecha_limKeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_fecha_limKeyTyped

    private void txtelpagoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtelpagoKeyTyped
        if(!Character.isDigit(evt.getKeyChar()))
            evt.consume();
        if(txtelpago.getText().length()>5)
            evt.consume();
    }//GEN-LAST:event_txtelpagoKeyTyped

    private void txtelpagadoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtelpagadoKeyTyped
        if(!Character.isDigit(evt.getKeyChar()))
            evt.consume();
        if(txtelpagado.getText().length()>5)
            evt.consume();
    }//GEN-LAST:event_txtelpagadoKeyTyped

    private void txtelporpagarKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtelporpagarKeyTyped
        if(!Character.isDigit(evt.getKeyChar()))
            evt.consume();
        if(txtelporpagar.getText().length()>5)
            evt.consume();
    }//GEN-LAST:event_txtelporpagarKeyTyped

    private void eliminarpagoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_eliminarpagoKeyTyped

    }//GEN-LAST:event_eliminarpagoKeyTyped

    private void pago3KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_pago3KeyTyped
        if(!Character.isDigit(evt.getKeyChar()))
            evt.consume();
        if(pago3.getText().length()>5)
            evt.consume();
    }//GEN-LAST:event_pago3KeyTyped

    private void total3KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_total3KeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_total3KeyTyped

    private void pagado3KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_pagado3KeyTyped
        if(!Character.isDigit(evt.getKeyChar()))
            evt.consume();
        if(pagado3.getText().length()>5)
            evt.consume();
    }//GEN-LAST:event_pagado3KeyTyped

    private void pagar3KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_pagar3KeyTyped
        if(!Character.isDigit(evt.getKeyChar()))
            evt.consume();
        if(pagar3.getText().length()>5)
            evt.consume();
    }//GEN-LAST:event_pagar3KeyTyped

    private void fecha_lim3KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_fecha_lim3KeyTyped
        if(fecha_lim3.getText().length()>10)
            evt.consume();
    }//GEN-LAST:event_fecha_lim3KeyTyped

    private void fecha_p3KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_fecha_p3KeyTyped
        if(fecha_p3.getText().length()>5)
            evt.consume();
    }//GEN-LAST:event_fecha_p3KeyTyped

    private void venta3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_venta3ActionPerformed

    }//GEN-LAST:event_venta3ActionPerformed

    private void venta3KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_venta3KeyTyped
        if(!Character.isDigit(evt.getKeyChar()))
            evt.consume();
        if(venta3.getText().length()>4)
            evt.consume();
    }//GEN-LAST:event_venta3KeyTyped

    private void fecha3KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_fecha3KeyTyped
        if(fecha3.getText().length()>10)
            evt.consume();
    }//GEN-LAST:event_fecha3KeyTyped

    private void objetos3ComponentResized(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_objetos3ComponentResized
        // TODO add your handling code here:
    }//GEN-LAST:event_objetos3ComponentResized

    private void objetos3KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_objetos3KeyTyped
        if(!Character.isDigit(evt.getKeyChar()))
            evt.consume();
        if(objetos3.getText().length()>4)
            evt.consume();
    }//GEN-LAST:event_objetos3KeyTyped

    private void monto3KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_monto3KeyTyped
        if(!Character.isDigit(evt.getKeyChar()))
            evt.consume();
        if(monto3.getText().length()>5)
            evt.consume();
    }//GEN-LAST:event_monto3KeyTyped

    private void folio3KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_folio3KeyTyped
        if(folio3.getText().length()>4)
            evt.consume();
    }//GEN-LAST:event_folio3KeyTyped
    ...
    private void nombre3KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_nombre3KeyTyped
        if(!Character.isLetter(evt.getKeyChar()) && Character.isDigit(evt.getKeyChar()))
            evt.consume();
        if(nombre3.getText().length()>49)
            evt.consume();
    }//GEN-LAST:event_nombre3KeyTyped

    private void ap_pat3KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ap_pat3KeyTyped
        if(!Character.isLetter(evt.getKeyChar()) && Character.isDigit(evt.getKeyChar()))
            evt.consume();
        if(ap_pat3.getText().length()>29)
            evt.consume();
    }//GEN-LAST:event_ap_pat3KeyTyped

    private void ap_mat3KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ap_mat3KeyTyped
        if(!Character.isLetter(evt.getKeyChar()) && Character.isDigit(evt.getKeyChar()))
            evt.consume();
        if(ap_mat3.getText().length()>29)
            evt.consume();
    }//GEN-LAST:event_ap_mat3KeyTyped

    private void municipio3KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_municipio3KeyTyped
        if(!Character.isLetter(evt.getKeyChar()) && Character.isDigit(evt.getKeyChar()))
            evt.consume();
        if(municipio3.getText().length()>29)
            evt.consume();
    }//GEN-LAST:event_municipio3KeyTyped
    ...
    private void localidad3KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_localidad3KeyTyped
        if(!Character.isLetter(evt.getKeyChar()) && Character.isDigit(evt.getKeyChar()))
            evt.consume();
        if(localidad3.getText().length()>14)
            evt.consume();
    }//GEN-LAST:event_localidad3KeyTyped

    private void calle3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_calle3ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_calle3ActionPerformed

    private void calle3KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_calle3KeyTyped
        if(!Character.isLetter(evt.getKeyChar()) && Character.isDigit(evt.getKeyChar()))
            evt.consume();
        if(calle3.getText().length()>49)
            evt.consume();
    }//GEN-LAST:event_calle3KeyTyped

    private void casa3KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_casa3KeyTyped
        if(!Character.isDigit(evt.getKeyChar()))
            evt.consume();
        if(casa3.getText().length()>4)
            evt.consume();
    }//GEN-LAST:event_casa3KeyTyped

    private void telefono3KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_telefono3KeyTyped
        if(!Character.isDigit(evt.getKeyChar()))
            evt.consume();
        if(telefono3.getText().length()>9)
            evt.consume();
    }//GEN-LAST:event_telefono3KeyTyped
    ...
    private javax.swing.JButton buscarpagos1;
    ...
    private javax.swing.JTextField fecha_lim;
    private javax.swing.JTextField fecha_lim3;
    private javax.swing.JTextField fecha_p3;
    private javax.swing.JTextField fecha_pag;
